<%--
    Inline SVG icon sprite, replacing the Font Awesome CDN font.

    Referenced as <svg class="icon"><use href="#i-name"/></svg>. Strokes use
    currentColor so icons take the colour of surrounding text in both themes.
--%>
